...
typedef enum
{
    BLUETERA_DATA_SINK_TYPE_DATA_SINK_TYPE_BLE = 0,
    BLUETERA_DATA_SINK_TYPE_DATA_SINK_TYPE_SDCARD = 1
} bluetera_data_sink_type_t;
#define BLUETERA_DATA_SINK_TYPE_MIN BLUETERA_DATA_SINK_TYPE_DATA_SINK_TYPE_BLE
#define BLUETERA_DATA_SINK_TYPE_MAX BLUETERA_DATA_SINK_TYPE_DATA_SINK_TYPE_SDCARD
#define BLUETERA_DATA_SINK_TYPE_ARRAYSIZE ((bluetera_data_sink_type_t)(BLUETERA_DATA_SINK_TYPE_DATA_SINK_TYPE_SDCARD+1))
...
typedef enum
{
    ...
    BLUETERA_IMU_DATA_TYPE_GYROSCOPE = 4
} bluetera_imu_data_type_t;
#define BLUETERA_IMU_DATA_TYPE_MIN BLUETERA_IMU_DATA_TYPE_UNKNOWN
#define BLUETERA_IMU_DATA_TYPE_MAX BLUETERA_IMU_DATA_TYPE_GYROSCOPE
#define BLUETERA_IMU_DATA_TYPE_ARRAYSIZE ((bluetera_imu_data_type_t)(BLUETERA_IMU_DATA_TYPE_GYROSCOPE+1))
...
typedef struct {
    ...
    bool has_z;
    float z;
/* @@protoc_insertion_point(struct:bluetera_imu_gyroscope_payload_t) */
} bluetera_imu_gyroscope_payload_t;
...
typedef struct {
    ...
    uint32_t gyro_fsr;
    bool has_data_sink;
    bluetera_data_sink_type_t data_sink;
...
typedef struct {
    ...
    union {
        ...
        bluetera_imu_gyroscope_payload_t gyroscope;
...
#define BLUETERA_IMU_GYROSCOPE_PAYLOAD_INIT_DEFAULT {false, 0, false, 0, false, 0, false, 0}
#define BLUETERA_DOWNLINK_MESSAGE_INIT_DEFAULT   {0, {BLUETERA_IMU_ACCELERATION_PAYLOAD_INIT_DEFAULT}}
#define BLUETERA_IMU_START_INIT_DEFAULT          {false, 0, false, 0, false, 0, false, 0, false, (bluetera_data_sink_type_t)0}
...
#define BLUETERA_IMU_GYROSCOPE_PAYLOAD_INIT_ZERO {false, 0, false, 0, false, 0, false, 0}
#define BLUETERA_DOWNLINK_MESSAGE_INIT_ZERO      {0, {BLUETERA_IMU_ACCELERATION_PAYLOAD_INIT_ZERO}}
#define BLUETERA_IMU_START_INIT_ZERO             {false, 0, false, 0, false, 0, false, 0, false, (bluetera_data_sink_type_t)0}
...
#define BLUETERA_IMU_GYROSCOPE_PAYLOAD_TIMESTAMP_TAG 1
#define BLUETERA_IMU_GYROSCOPE_PAYLOAD_X_TAG     2
#define BLUETERA_IMU_GYROSCOPE_PAYLOAD_Y_TAG     3
#define BLUETERA_IMU_GYROSCOPE_PAYLOAD_Z_TAG     4
...
extern const pb_field_t bluetera_imu_gyroscope_payload_fields[5];
extern const pb_field_t bluetera_downlink_message_fields[6];
extern const pb_field_t bluetera_imu_start_fields[6];
...
#define BLUETERA_IMU_GYROSCOPE_PAYLOAD_SIZE      21
#define BLUETERA_DOWNLINK_MESSAGE_SIZE           28
#define BLUETERA_IMU_START_SIZE                  25
#define BLUETERA_IMU_COMMAND_SIZE                27
#define BLUETERA_UPLINK_MESSAGE_SIZE             29
