...
typedef struct {
    ...
    bool has_isOn;
    bool isOn;
/* @@protoc_insertion_point(struct:bluetera_led_command_t) */
...
#define BLUETERA_LED_COMMAND_INIT_DEFAULT        {false, 0, false, 0}
...
#define BLUETERA_LED_COMMAND_INIT_ZERO           {false, 0, false, 0}
...
#define BLUETERA_LED_COMMAND_LEDID_TAG           1
#define BLUETERA_LED_COMMAND_ISON_TAG            2
...
#define BLUETERA_UPLINK_MESSAGE_LED_TAG          18
...
extern const pb_field_t bluetera_led_command_fields[3];
extern const pb_field_t bluetera_uplink_message_fields[4];
...
#define BLUETERA_LED_COMMAND_SIZE                8
