...
#define BLUETERA_IMU_COMMAND_TYPE_MAX BLUETERA_IMU_COMMAND_TYPE_SET_FSR
#define BLUETERA_IMU_COMMAND_TYPE_ARRAYSIZE ((bluetera_imu_command_type_t)(BLUETERA_IMU_COMMAND_TYPE_SET_FSR+1))

typedef enum
{
    BLUETERA_IMU_SENSOR_TYPE_QUATERNION = 1,
    BLUETERA_IMU_SENSOR_TYPE_ACCELEROMETER = 2,
    BLUETERA_IMU_SENSOR_TYPE_RAW = 3
} bluetera_imu_sensor_type_t;
#define BLUETERA_IMU_SENSOR_TYPE_MIN BLUETERA_IMU_SENSOR_TYPE_QUATERNION
#define BLUETERA_IMU_SENSOR_TYPE_MAX BLUETERA_IMU_SENSOR_TYPE_RAW
#define BLUETERA_IMU_SENSOR_TYPE_ARRAYSIZE ((bluetera_imu_sensor_type_t)(BLUETERA_IMU_SENSOR_TYPE_RAW+1))
...
typedef struct {
    ...
    pb_size_t which_payload;
    union {
        bluetera_imu_sensor_type_t sensor;
...
#define BLUETERA_IMU_COMMAND_INIT_DEFAULT        {(bluetera_imu_command_type_t)0, 0, {(bluetera_imu_sensor_type_t)0}}
...
#define BLUETERA_IMU_COMMAND_INIT_ZERO           {(bluetera_imu_command_type_t)0, 0, {(bluetera_imu_sensor_type_t)0}}
