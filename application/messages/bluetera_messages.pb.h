...
typedef enum
{
    BLUETERA_IMU_COMMAND_TYPE_START = 0,
    BLUETERA_IMU_COMMAND_TYPE_STOP = 1,
    BLUETERA_IMU_COMMAND_TYPE_SET_FSR = 2,
    BLUETERA_IMU_COMMAND_TYPE_CONFIG = 3
} bluetera_imu_command_type_t;
#define BLUETERA_IMU_COMMAND_TYPE_MIN BLUETERA_IMU_COMMAND_TYPE_START
#define BLUETERA_IMU_COMMAND_TYPE_MAX BLUETERA_IMU_COMMAND_TYPE_CONFIG
#define BLUETERA_IMU_COMMAND_TYPE_ARRAYSIZE ((bluetera_imu_command_type_t)(BLUETERA_IMU_COMMAND_TYPE_CONFIG+1))
...
typedef struct {
    uint32_t acc;
    uint32_t gyro;
/* @@protoc_insertion_point(struct:bluetera_imu_set_fsr_payload_t) */
} bluetera_imu_set_fsr_payload_t;
...
typedef struct {
    bluetera_imu_command_type_t command;
    pb_size_t which_payload;
    union {
        bluetera_imu_data_type_t sensor;
        bluetera_imu_set_fsr_payload_t fsr;
    } payload;
...
#define BLUETERA_ERROR_INIT_DEFAULT              {(bluetera_bluetera_modules_type_t)0, 0}
...
#define BLUETERA_IMU_SET_FSR_PAYLOAD_INIT_DEFAULT {0, 0}
#define BLUETERA_IMU_CONFIG_INIT_DEFAULT         {(bluetera_imu_data_type_t)0, 0, 0, 0}
#define BLUETERA_IMU_COMMAND_INIT_DEFAULT        {(bluetera_imu_command_type_t)0, 0, {(bluetera_imu_data_type_t)0}}
#define BLUETERA_UPLINK_MESSAGE_INIT_DEFAULT     {0, {BLUETERA_IMU_COMMAND_INIT_DEFAULT}}
#define BLUETERA_ECHO_PAYLOAD_INIT_ZERO          {""}
#define BLUETERA_ERROR_INIT_ZERO                 {(bluetera_bluetera_modules_type_t)0, 0}
...
#define BLUETERA_IMU_SET_FSR_PAYLOAD_INIT_ZERO   {0, 0}
#define BLUETERA_IMU_CONFIG_INIT_ZERO            {(bluetera_imu_data_type_t)0, 0, 0, 0}
#define BLUETERA_IMU_COMMAND_INIT_ZERO           {(bluetera_imu_command_type_t)0, 0, {(bluetera_imu_data_type_t)0}}
...
#define BLUETERA_IMU_SET_FSR_PAYLOAD_ACC_TAG     1
#define BLUETERA_IMU_SET_FSR_PAYLOAD_GYRO_TAG    2
...
#define BLUETERA_IMU_COMMAND_SENSOR_TAG          2
#define BLUETERA_IMU_COMMAND_FSR_TAG             3
#define BLUETERA_IMU_COMMAND_COMMAND_TAG         1
...
extern const pb_field_t bluetera_imu_set_fsr_payload_fields[3];
...
#define BLUETERA_IMU_SET_FSR_PAYLOAD_SIZE        12
#define BLUETERA_IMU_CONFIG_SIZE                 20
#define BLUETERA_IMU_COMMAND_SIZE                16
#define BLUETERA_UPLINK_MESSAGE_SIZE             18
